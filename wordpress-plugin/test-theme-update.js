...
const req = http.request(options, (res) => {
  ...
  res.on('end', () => {
    try {
      ...
      console.log('  Primary Color:', config.styling?.primaryColor || 'Not set');
      console.log('  Background:', config.styling?.backgroundColor || 'Not set');
      console.log('  Border Radius:', config.styling?.borderRadius || 'Not set');
      console.log('  Font Family:', config.styling?.fontFamily || 'Not set');
      
      console.log('\n🔧 Embed Settings:');
      console.log('  Default Height:', config.embedSettings?.defaultHeight || 'Not set');
      ...
      console.log('6. Check the widget on your WordPress site to see updated styles');
