...
(function () {
  ...
  window.CardStream = {
    ...
    render: function (container, config) {
      ...
      wrapper.innerHTML = `
        <div class="cs-layout">
          <div class="cs-visual-panel">
            <div class="cs-visual-content">
              <div class="cs-visual-header">
                <h1 class="cs-visual-title">Energy Savings Calculator</h1>
                <p class="cs-visual-subtitle">Calculate your potential energy savings and environmental impact</p>
              </div>
              <div class="cs-visual-info" id="${config.container}-visual-info">
                <div class="cs-info-step">
          ...
          <div class="cs-card-stream" id="${config.container}-stream">
    ...
    renderPropertyForm: function (streamContainer, visualInfo, instance) {
      ...
      streamContainer.innerHTML = `
        <div class="cs-card cs-form-card" data-step="1">
          <div class="cs-card-header">
            <span class="cs-step-indicator">Step 1 of 3</span>
            <div class="cs-card-badge">Property Info</div>
          </div>
          <h2 class="cs-card-title">Tell us about your property</h2>
          <p class="cs-card-description">We need some basic information to calculate your potential energy savings and provide accurate recommendations.</p>
          
          <form class="cs-form" id="${config.container}-property-form">
            <div class="cs-form-group">
              <label class="cs-label">Property Type</label>
              <select class="cs-input cs-select" name="propertyType" required>
            ...
            <div class="cs-field-row">
              <div class="cs-form-group">
                <label class="cs-label">Floor Area (m²)</label>
                <input type="number" class="cs-input" name="floorArea" placeholder="e.g. 120" required />
              </div>
              <div class="cs-form-group">
                <label class="cs-label">Construction Year</label>
                <input type="number" class="cs-input" name="constructionYear" placeholder="e.g. 1985" />
              </div>
            </div>
            
            <div class="cs-form-group">
              <label class="cs-label">Current Heating System</label>
              <select class="cs-input cs-select" name="heatingSystem" required>
            ...
            <div class="cs-form-actions">
              <button type="submit" class="cs-button cs-button-primary" disabled>
                Calculate Savings
              </button>
            </div>
          </form>
    ...
    renderCalculationResults: function (streamContainer, visualInfo, instance) {
      ...
      streamContainer.innerHTML = `
        <div class="cs-card cs-calculation-card" data-step="2">
          <div class="cs-card-header">
            <span class="cs-step-indicator">Results</span>
            <div class="cs-card-badge cs-badge-success">Excellent Potential</div>
          </div>
          <h2 class="cs-card-title">Your Energy Savings Potential</h2>
          <p class="cs-card-description">Based on your property details, here's what you could save:</p>
          
          <div class="cs-metrics">
            <div class="cs-metric cs-metric-primary">
              <div class="cs-metric-label">Annual Savings</div>
              <div class="cs-metric-value">€${results.potentialSavings.toLocaleString()}</div>
            </div>
            
            <div class="cs-metrics-grid">
              <div class="cs-metric">
                <div class="cs-metric-label">Current Annual Cost</div>
                <div class="cs-metric-value">€${results.currentCost.toLocaleString()}</div>
              </div>
              <div class="cs-metric">
                <div class="cs-metric-label">CO₂ Reduction</div>
                <div class="cs-metric-value">${results.co2Reduction} <span class="cs-metric-unit">tonnes/year</span></div>
              </div>
              <div class="cs-metric">
                <div class="cs-metric-label">Payback Period</div>
                <div class="cs-metric-value">${results.paybackPeriod} <span class="cs-metric-unit">years</span></div>
              </div>
              <div class="cs-metric">
                <div class="cs-metric-label">Monthly Savings</div>
                <div class="cs-metric-value">€${Math.round(results.potentialSavings / 12)}</div>
              </div>
            </div>
          </div>
          
          <div class="cs-form-actions">
            <button type="button" class="cs-button cs-button-primary" onclick="window.CardStream.nextStep('${config.container}')">
              Get Detailed Report
            </button>
          </div>
        </div>
    ...
    renderEmailForm: function (streamContainer, visualInfo, instance) {
      ...
      streamContainer.innerHTML = `
        <div class="cs-card cs-form-card" data-step="3">
          <div class="cs-card-header">
            <span class="cs-step-indicator">Step 2 of 3</span>
            <div class="cs-card-badge">Contact Info</div>
          </div>
          <h2 class="cs-card-title">Get your detailed report</h2>
          <p class="cs-card-description">Enter your email to receive a comprehensive energy efficiency report with specific recommendations and next steps.</p>
          
          <form class="cs-form" id="${config.container}-email-form">
            <div class="cs-form-group">
              <label class="cs-label">Email Address</label>
              <input type="email" class="cs-input" name="email" placeholder="your@email.com" required />
            </div>
            
            <div class="cs-form-group">
              <label class="cs-checkbox-wrapper">
                <input type="checkbox" name="newsletter" class="cs-checkbox" />
                <span class="cs-checkbox-label">I'd like to receive energy efficiency tips and updates</span>
              </label>
            </div>
    ...
    renderCompletion: function (streamContainer, visualInfo, instance) {
      ...
      streamContainer.innerHTML = `
        <div class="cs-card cs-success-card" data-step="4">
          <div class="cs-card-header">
            <div class="cs-card-badge cs-badge-success">Complete</div>
          </div>
          <h2 class="cs-card-title">Report Sent Successfully! 🎉</h2>
          <p class="cs-card-description">We've sent your detailed energy efficiency report to your email. Check your inbox for personalized recommendations and next steps.</p>
          
          <div class="cs-info-list">
            <div class="cs-info-item">
              <div class="cs-info-icon">📋</div>
              <div class="cs-info-text">Review recommendations in your email</div>
            </div>
            <div class="cs-info-item">
              <div class="cs-info-icon">🔍</div>
              <div class="cs-info-text">Contact certified installers for quotes</div>
            </div>
            <div class="cs-info-item">
              <div class="cs-info-icon">💰</div>
              <div class="cs-info-text">Check available government incentives</div>
            </div>
          </div>
          
          <div class="cs-form-actions cs-actions-multi">
            <button type="button" class="cs-button cs-button-primary" onclick="window.CardStream.restart('${config.container}')">
              Start New Assessment
            </button>
            <button type="button" class="cs-button cs-button-secondary" onclick="window.open('https://example.com/installers', '_blank')">
              Find Installers
            </button>
          </div>
        </div>
    ...
    handlePropertySubmit: function (form, instance) {
      ...
      // Show loading state
      form.innerHTML =
        '<div class="cs-loading"><div class="cs-spinner"></div><p>Calculating your savings...</p></div>';
    ...
    handleEmailSubmit: function (form, instance) {
      ...
      // Show loading state
      form.innerHTML =
        '<div class="cs-loading"><div class="cs-spinner"></div><p>Sending your report...</p></div>';
