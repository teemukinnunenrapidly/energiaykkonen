...
console.log(
  '- Current annual heating cost (menekinhintavuosi):',
  testLead.form_data.menekinhintavuosi,
  '€'
);
console.log(
  '- Energy need (laskennallinenenergiantarve):',
  testLead.form_data.laskennallinenenergiantarve,
  'kWh/year'
);
console.log(
  '- Heating type (lammitysmuoto):',
  testLead.form_data.lammitysmuoto
);
...
console.log(
  ...
  results.new_electricity_consumption,
  'kWh/year'
);
...
const expectedHeatPumpConsumption = Math.round(
  testLead.form_data.laskennallinenenergiantarve / 3.8
);
const expectedHeatPumpCost = Math.round(expectedHeatPumpConsumption * 0.15);
const expectedSavings =
  testLead.form_data.menekinhintavuosi - expectedHeatPumpCost;

console.log(
  'Heat pump consumption check:',
