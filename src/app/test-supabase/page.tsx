    ...
    <div className="container mx-auto p-8">
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>
            Test your Supabase connection and verify environment variables are set correctly.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="text-sm text-gray-600">
            ...
            <ol className="list-decimal list-inside space-y-1">
              <li>Create a Supabase project at <a href="https://supabase.com" className="text-blue-600 hover:underline">supabase.com</a></li>
