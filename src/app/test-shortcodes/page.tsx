            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="current-heating-cost">
                  ...
                  <Input
                    ...
                    onChange={e =>
                      updateVariable('currentHeatingCost', e.target.value)
                    }
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={e =>
                      updateVariable('newHeatingCost', e.target.value)
                    }
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={e =>
                      updateVariable('investmentCost', e.target.value)
                    }
                  />
                </div>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mb-2">
                    Shortcodes are automatically processed when form variables
                    change, providing instant feedback to users.
                  </p>
