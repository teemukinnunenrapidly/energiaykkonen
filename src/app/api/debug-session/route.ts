...
export async function GET(request: Request) {
  try {
    ...
    return NextResponse.json({
      ...
      hasEnergyCalculation: 'Laskennallinen energiantarve (kwh)' in sessionData.calculations,
      energyCalculationValue: sessionData.calculations['Laskennallinen energiantarve (kwh)']?.value || null
    });
