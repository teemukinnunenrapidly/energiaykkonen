...
interface StrategyConfig {
  ...
  title: string;
  matchesWhenIncludes: string; // simple demo matching rule
  excludeIfIncludes?: string;
  consumptionSource: string; // e.g. kokonaismenekki | energy/10 | gas_m3 | puumotti
  priceFormula: string; // e.g. menekinhintavuosi | liters * oilPrice
...
const baseRows: PdfRowConfig[] = [
  { key: 'consumption', label: 'Kulutus', unit: '', enabled: true },
  { key: 'price', label: 'Energian hinta', unit: '€/vuosi', enabled: true },
