...
import { applyCardStreamTheme, getCardStreamConfig, getConfigValue } from '../../../lib/cardstream-theme-applier';
    ...
    <div style={{ margin: 'var(--cs-spacing-8)' }}>
      ...
      <div style={{ 
        ...
        <p style={{ 
          ...
          Change the brand color by clicking the buttons below. This demonstrates how editing the cardstream-complete-config.json file would work.
        </p>
        ...
        <div style={{ 
          ...
          Current brand color: <strong style={{ color: 'var(--cs-color-brand-primary)' }}>
            {getConfigValue('colors.brand.primary')}
          </strong>
        </div>
      </div>
      ...
      <CardStreamContainer>
        <VisualPanel>
          <div className="cs-visual-panel-content">
            ...
            <p style={{
              ...
              Watch how the entire system updates when you change the brand color above.
            </p>
          </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              The entire CardStream system is controlled by a single JSON file. Change any value and the UI updates instantly.
            </div>
            <div style={{
              marginTop: '16px',
              padding: '12px',
              ...
              💡 Tip: In production, you'd edit cardstream-complete-config.json directly instead of using buttons.
            </div>
          </div>
        </VisualPanel>
        ...
        <CardStream>
            ...
            metrics={[
              {
                ...
                value: getConfigValue('colors.brand.primary') || '#10b981'
              },
              {
                label: "Theme",
          ...
          <div style={{
            ...
            <div style={{ color: 'var(--cs-color-text-secondary)', marginBottom: 'var(--cs-spacing-2)' }}>
...
{`{
  "cardStreamConfig": {
    "colors": {
      "brand": {
        "primary": "${getConfigValue('colors.brand.primary')}"
      }
    }
  }
}`}
          ...
          <div style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--cs-spacing-4)' }}>
              <div>
