...
export function AvailableFields() {
  const leadFields = [
    ...
    {
      name: 'current_heating_cost',
      type: 'number',
      description: 'Nykyiset lämmityskulut (€/vuosi)',
    },
    {
      name: 'current_energy_consumption',
      type: 'number',
      description: 'Energiankulutus (kWh/vuosi)',
    },
    ...
    { name: 'residents', type: 'number', description: 'Asukkaiden määrä' },
    {
      ...
      type: 'string',
      description: 'Käyttöveden kulutus',
    },

    // Calculated Values
    {
      name: 'annual_energy_need',
      type: 'number',
      description: 'Laskennallinen energiantarve (kWh)',
    },
    {
      name: 'heat_pump_consumption',
      type: 'number',
      description: 'Lämpöpumpun kulutus (kWh)',
    },
    {
      name: 'heat_pump_cost_annual',
      type: 'number',
      description: 'Lämpöpumpun vuosikulu (€)',
    },
    {
      name: 'annual_savings',
      type: 'number',
      description: 'Vuosittainen säästö (€)',
    },
    {
      name: 'five_year_savings',
      type: 'number',
      description: '5 vuoden säästö (€)',
    },
    {
      name: 'ten_year_savings',
      type: 'number',
      description: '10 vuoden säästö (€)',
    },
    {
      name: 'payback_period',
      type: 'number',
      description: 'Takaisinmaksuaika (vuotta)',
    },
    {
      name: 'co2_reduction',
      type: 'number',
      description: 'CO₂ vähennys (kg/vuosi)',
    },
          ...
          <div className="space-y-2">
            <div className="p-3 bg-muted rounded-lg">
              <code className="text-sm">
                annual_savings / current_heating_cost * 100
              </code>
            ...
            <div className="p-3 bg-muted rounded-lg">
              <code className="text-sm">
                square_meters * ceiling_height * 40
              </code>
              <p className="text-xs text-muted-foreground mt-1">
                Arvioitu lämmitystarve
              </p>
            </div>
