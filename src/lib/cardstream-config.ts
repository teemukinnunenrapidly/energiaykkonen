...
class CardStreamConfigService {
  ...
  generateCSSVariables(): string {
    ...
    cssVariables.push(
      `  --cs-container-border-radius: ${container.borderRadius};`
    );
    ...
    cssVariables.push(
      `  --cs-visual-support-ratio: ${layout.visualSupportRatio};`
    );
    ...
    cssVariables.push(
      `  --cs-visual-support-background: ${visualSupport.background};`
    );
    cssVariables.push(
      `  --cs-visual-support-border-right: ${visualSupport.borderRight};`
    );
    cssVariables.push(
      `  --cs-visual-support-content-background: ${visualSupport.content.background};`
    );
    cssVariables.push(
      `  --cs-visual-support-content-padding: ${visualSupport.content.padding};`
    );

    // Card stream variables
    const cardStream = config.cardStream;
    cssVariables.push(
      `  --cs-card-stream-background: ${cardStream.background};`
    );
    ...
    cssVariables.push(
      `  --cs-font-weight-light: ${typography.fontWeightLight};`
    );
    cssVariables.push(
      `  --cs-font-weight-normal: ${typography.fontWeightNormal};`
    );
    cssVariables.push(
      `  --cs-font-weight-medium: ${typography.fontWeightMedium};`
    );
    cssVariables.push(
      `  --cs-font-weight-semibold: ${typography.fontWeightSemibold};`
    );

    // Card text variables
    cssVariables.push(`  --cs-card-title-font-size: ${card.title.fontSize};`);
    cssVariables.push(
      `  --cs-card-title-font-weight: ${card.title.fontWeight};`
    );
    cssVariables.push(`  --cs-card-title-color: ${card.title.color};`);
    cssVariables.push(
      `  --cs-card-title-line-height: ${card.title.lineHeight};`
    );
    cssVariables.push(
      `  --cs-card-title-margin-bottom: ${card.title.marginBottom};`
    );

    cssVariables.push(
      `  --cs-card-description-font-size: ${card.description.fontSize};`
    );
    cssVariables.push(
      `  --cs-card-description-color: ${card.description.color};`
    );
    cssVariables.push(
      `  --cs-card-description-line-height: ${card.description.lineHeight};`
    );
    cssVariables.push(
      `  --cs-card-description-margin-bottom: ${card.description.marginBottom};`
    );

    // Step indicator variables
    cssVariables.push(
      `  --cs-step-indicator-font-size: ${card.stepIndicator.fontSize};`
    );
    cssVariables.push(
      `  --cs-step-indicator-font-weight: ${card.stepIndicator.fontWeight};`
    );
    cssVariables.push(
      `  --cs-step-indicator-color: ${card.stepIndicator.color};`
    );
    cssVariables.push(
      `  --cs-step-indicator-text-transform: ${card.stepIndicator.textTransform};`
    );
    cssVariables.push(
      `  --cs-step-indicator-letter-spacing: ${card.stepIndicator.letterSpacing};`
    );
    cssVariables.push(
      `  --cs-step-indicator-margin-bottom: ${card.stepIndicator.marginBottom};`
    );

    // Form elements
    const formElements = config.formElements;
    cssVariables.push(
      `  --cs-form-group-margin-bottom: ${formElements.formGroup.marginBottom};`
    );
    cssVariables.push(`  --cs-field-row-gap: ${formElements.fieldRow.gap};`);
    cssVariables.push(
      `  --cs-field-row-margin-bottom: ${formElements.fieldRow.marginBottom};`
    );

    // Label variables
    cssVariables.push(
      `  --cs-label-font-size: ${formElements.label.fontSize};`
    );
    cssVariables.push(
      `  --cs-label-font-weight: ${formElements.label.fontWeight};`
    );
    cssVariables.push(`  --cs-label-color: ${formElements.label.color};`);
    cssVariables.push(
      `  --cs-label-text-transform: ${formElements.label.textTransform};`
    );
    cssVariables.push(
      `  --cs-label-letter-spacing: ${formElements.label.letterSpacing};`
    );
    cssVariables.push(
      `  --cs-label-margin-bottom: ${formElements.label.marginBottom};`
    );
    ...
    cssVariables.push(
      `  --cs-input-placeholder-color: ${input.placeholder.color};`
    );
    cssVariables.push(
      `  --cs-input-hover-border-color: ${input.hover.borderBottomColor};`
    );
    cssVariables.push(
      `  --cs-input-focus-border-color: ${input.focus.borderBottomColor};`
    );
    cssVariables.push(
      `  --cs-input-error-border-color: ${input.error.borderBottomColor};`
    );
    ...
    cssVariables.push(
      `  --cs-color-brand-primary-hover: ${colors.brand.primaryHover};`
    );
    cssVariables.push(
      `  --cs-color-brand-primary-light: ${colors.brand.primaryLight};`
    );
    ...
    cssVariables.push(
      `  --cs-color-text-placeholder: ${colors.text.placeholder};`
    );
    cssVariables.push(`  --cs-color-text-inverse: ${colors.text.inverse};`);

    cssVariables.push(
      `  --cs-color-background-primary: ${colors.background.primary};`
    );
    cssVariables.push(
      `  --cs-color-background-secondary: ${colors.background.secondary};`
    );
    cssVariables.push(
      `  --cs-color-background-tertiary: ${colors.background.tertiary};`
    );
    cssVariables.push(
      `  --cs-color-background-disabled: ${colors.background.disabled};`
    );
    ...
    cssVariables.push(
      `  --cs-calculation-card-background: ${calculationCard.background};`
    );
    cssVariables.push(
      `  --cs-calculation-card-border-left-color: ${calculationCard.borderLeftColor};`
    );
    cssVariables.push(
      `  --cs-metric-value-font-size: ${calculationCard.metricValue.fontSize};`
    );
    cssVariables.push(
      `  --cs-metric-value-font-weight: ${calculationCard.metricValue.fontWeight};`
    );
    cssVariables.push(
      `  --cs-metric-value-color: ${calculationCard.metricValue.color};`
    );
    cssVariables.push(
      `  --cs-metric-value-line-height: ${calculationCard.metricValue.lineHeight};`
    );
    cssVariables.push(
      `  --cs-metric-value-margin-bottom: ${calculationCard.metricValue.marginBottom};`
    );

    // Action card button variables
    const actionCard = config.actionCard;
    cssVariables.push(
      `  --cs-action-card-text-align: ${actionCard.textAlign};`
    );
    cssVariables.push(`  --cs-action-card-padding: ${actionCard.padding};`);
    cssVariables.push(
      `  --cs-action-button-padding: ${actionCard.button.padding};`
    );
    cssVariables.push(
      `  --cs-action-button-font-size: ${actionCard.button.fontSize};`
    );
    cssVariables.push(
      `  --cs-action-button-font-weight: ${actionCard.button.fontWeight};`
    );
    cssVariables.push(
      `  --cs-action-button-color: ${actionCard.button.color};`
    );
    cssVariables.push(
      `  --cs-action-button-background: ${actionCard.button.background};`
    );
    cssVariables.push(
      `  --cs-action-button-border: ${actionCard.button.border};`
    );
    cssVariables.push(
      `  --cs-action-button-border-bottom: ${actionCard.button.borderBottom};`
    );
    cssVariables.push(
      `  --cs-action-button-border-radius: ${actionCard.button.borderRadius};`
    );
    cssVariables.push(
      `  --cs-action-button-text-transform: ${actionCard.button.textTransform};`
    );
    cssVariables.push(
      `  --cs-action-button-letter-spacing: ${actionCard.button.letterSpacing};`
    );
    cssVariables.push(
      `  --cs-action-button-transition: ${actionCard.button.transition};`
    );
    cssVariables.push(
      `  --cs-action-button-hover-background: ${actionCard.button.hover.background};`
    );
    cssVariables.push(
      `  --cs-action-button-hover-color: ${actionCard.button.hover.color};`
    );
    cssVariables.push(
      `  --cs-action-button-hover-transform: ${actionCard.button.hover.transform};`
    );

    // Animation variables
    const animations = config.animations;
    cssVariables.push(
      `  --cs-animation-duration-fast: ${animations.transitions.fast};`
    );
    cssVariables.push(
      `  --cs-animation-duration-default: ${animations.transitions.default};`
    );
    cssVariables.push(
      `  --cs-animation-duration-slow: ${animations.transitions.slow};`
    );
    cssVariables.push(
      `  --cs-animation-duration-slower: ${animations.transitions.slower};`
    );
    cssVariables.push(
      `  --cs-card-reveal-duration: ${animations.cardReveal.duration};`
    );
    cssVariables.push(
      `  --cs-card-reveal-easing: ${animations.cardReveal.easing};`
    );

    // Responsive breakpoints
    const responsive = config.responsive;
    cssVariables.push(
      `  --cs-breakpoint-mobile: ${responsive.breakpoints.mobile};`
    );
    cssVariables.push(
      `  --cs-breakpoint-tablet: ${responsive.breakpoints.tablet};`
    );
    cssVariables.push(
      `  --cs-breakpoint-desktop: ${responsive.breakpoints.desktop};`
    );
    ...
    cssVariables.push(
      `    border-radius: ${responsive.mobile.card.borderRadius};`
    );
    cssVariables.push(
      `    margin-bottom: ${responsive.mobile.card.marginBottom};`
    );
    cssVariables.push('  }');
    cssVariables.push('  .cs-field-row {');
    cssVariables.push(
      `    grid-template-columns: ${responsive.mobile.fieldRow.gridTemplateColumns};`
    );
